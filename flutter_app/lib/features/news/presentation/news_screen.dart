                    ...
                    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Row(children: [
                          ...
                          const Spacer(),
                          Text(a['published_at'] ?? '', style: const TextStyle(color: AppTheme.muted, fontSize: 11)),
                        ]),
                        const SizedBox(height: 6),
                        Text(a['title'] ?? '', style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14, color: AppTheme.text)),
                        const SizedBox(height: 4),
                        Text(a['summary'] ?? '', style: const TextStyle(fontSize: 12, color: AppTheme.muted), maxLines: 2),
                      ])),
                    ]),
                  )),
                ]),
