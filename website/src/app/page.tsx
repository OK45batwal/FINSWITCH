        ...
        <section className="pt-32 pb-20 px-4 text-center bg-gradient-to-b from-surface/50 to-transparent">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4 justify-center mb-12">
              ...
              <a href="https://github.com/OK45batwal/FINSWITCH/releases/latest/download/app-release.apk" className="border border-border hover:border-brand text-foreground px-8 py-3 rounded-lg text-lg">
        ...
        <section id="download" className="py-20 px-4 bg-surface/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <a href="https://github.com/OK45batwal/FINSWITCH/releases/latest/download/app-release.apk" className="border border-border hover:border-brand text-foreground px-8 py-3 rounded-lg">
                Download APK
              </a>
            </div>
          </div>
